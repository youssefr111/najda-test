  ...
  return (
    <div className="flex flex-col w-full mt-4 gap-6">
      <div className="flex justify-between items-center">
        ...
        {!isEditing && (
          <button type="button" onClick={() => setIsEditing(true)} className="flex items-center gap-1.5 text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors">
